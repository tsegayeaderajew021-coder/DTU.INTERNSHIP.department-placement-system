...
const EditDepartment = () => {
  ...
  const handleSubmit = async event => {
    ...
    setError('');
    try {
      const response = await api.put('departments_api.php', { id: Number(id), name, description: form.description.trim(), stream: form.stream, college_name: form.college_name });
